...
class Student extends CI_Controller {
	...
	public function authentication(){
		...
		$table					= StudentModel::where('identity_number',$identity_number)->first();
		...
		$url 			= (!$this->session->userdata('catched_location_student')) ? '/student/dashboard' : $this->session->userdata('catched_location_student');
		$this->restapi->response($url);
