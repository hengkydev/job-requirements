...
<div class="page-header page-header-default border-top-lg border-top-primary">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			...
			<li><a href="{{base_url("superuser/seo")}}">SEO</a></li>
		...
		<div class="panel panel-flat">
			<div class="panel-body">
				<div class="form-group">
					<label><b class="text-danger position-left">*</b><i>Default</i> Judul Website : </label>
					<input type="text" name="title" value="{{@$table->title}}" class="form-control" placeholder="Ketikan Judul Website" required="">
				</div>
				<div class="form-group">
					<label><b class="text-danger position-left">*</b><i>Default</i> Author Website : </label>
					<input type="text" name="author" value="{{@$table->author}}" class="form-control" placeholder="Ketikan Pembuat Konten Website" required="">
				</div>
				<div class="form-group">
