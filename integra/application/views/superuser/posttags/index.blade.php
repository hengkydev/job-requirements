...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-flat panel-body">
			<form id="form-bulkaction" method="post" action="{{base_url('superuser/posttags/bulkaction')}}">
				<div class="row">
					<div class="col-sm-1">
						<div class="checkbox">
							<label>
					...
					<div class="col-md-2 text-right pull-right">
						<a href="{{base_url("superuser/posttags/create")}}" class="btn bg-pink btn-labeled heading-btn legitRipple" >
						...
						<tr>
							...
							<td>
								<div class="media-body">
									<a href="{{base_url('superuser/posttags/update/'.$result->id)}}" 
								...
								<ul class="icons-list">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="{{base_url('superuser/posttags/update/'.$result->id)}}">
												<i class=" icon-pencil7"></i> update data</a>
											</li>
											<li>
												<a data-url="{{base_url('superuser/posttags/remove/'.$result->id)}}" 
