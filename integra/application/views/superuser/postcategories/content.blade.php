...
<div class="page-header page-header-default border-top-lg border-top-primary">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			...
			<li><a href="{{base_url("superuser/postcategories")}}">Kategori</a></li>
		...
		<div class="panel panel-flat">
			<div class="panel-body">
				<div class="form-group">
					<label><b class="text-danger position-left">*</b>Nama Kategori : </label>
					@if($type!="create")
							<input type="hidden" name="id" value="{{$table->id}}">
					@endif
					<input type="text" name="name" value="{{@$table->name}}" class="form-control" placeholder="Ketikan Nama Kategori di sini ..." required="">
				</div>
				<div class="form-group">
					<label>Isi Deskripsi Kategori : </label>
					<textarea class="form-control" name="description" rows="6" placeholder="Deskripsi Kategori">{{ @$table->description }}</textarea>
				</div>
			</div>
		</div>
	</div>
