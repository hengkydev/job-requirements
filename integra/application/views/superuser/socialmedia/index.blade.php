...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-flat panel-body">
			<form id="form-bulkaction" method="post" action="{{base_url('superuser/socialmedia/bulkaction')}}">
				<div class="row">
					<div class="col-sm-1">
						<div class="checkbox">
							<label>
					...
					<div class="col-md-2 text-right pull-right">
						<a href="{{base_url("superuser/socialmedia/create")}}" class="btn bg-pink btn-labeled heading-btn legitRipple" >
				...
				<tbody>
					@foreach($table as $result)
						<tr>
							...
							<td>
								<span class="label border-left-primary label-striped">{{$result->type}}</span>
							</td>
							<td>
								<div class="media-body">
									<a href="{{base_url('superuser/socialmedia/update/'.$result->id)}}" 
										class="display-inline-block text-semibold letter-icon-title text-warning">
										{{$result->name}}
									</a>
								</div>
							</td>
							<td>
								<a href="{{$result->url}}" target="_blank" class="text-readmore">
									{{$result->url}}
								</a>
							</td>
								...
								<ul class="icons-list">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="{{base_url('superuser/socialmedia/update/'.$result->id)}}">
												<i class=" icon-pencil7"></i> update data</a>
											</li>
											<li>
												<a data-url="{{base_url('superuser/socialmedia/remove/'.$result->id)}}" 
