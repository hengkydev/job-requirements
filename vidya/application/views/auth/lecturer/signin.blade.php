@extends("auth.lecturer.template")
              ...
              <div class="col-md-5">
                <div class="panel-body">
                  <h4 class="no-margin text-light media">
                    <div class="media-left">
                     ...
                     <div class="media-body">
                        Masuk Sebagai <span class="text-semibold text-primary">Pengajar</span>
                        <div class="text-sm text-grey">
                          masuk sistem e-learning sebagai pengajar
                        </div>
                     </div>
                  </h4>
                  <div class="gap-md"></div>
                  <form action="{{base_url('auth/lecturer/authentication')}}" class="form-validate form-aksa-submit" data-type="notif" method="POST">
                       <div class="form-group has-feedback has-feedback-left">
                          <input type="text" name="identity_number" class="form-control" placeholder="No Identitas" required="">
                  ...
                  <div class="help-block text-light text-center">
                    Belum mempunyai akun <span class="text-semibold">Pengajar</span> ?  
                    <a href="{{base_url('auth/student/register')}}"><u>Tambahkan Akun </u></a>
                  </div>
                  <div class="content-divider text-muted form-group"><span>Atau Daftar Dengan</div>
                   <a href="{{base_url('superuser/lecturer/create')}}" class="btn border-primary text-primary btn-flat btn-block btn-xs legitRipple" target="_blank">
