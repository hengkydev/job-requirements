  <!--------------------
        ...
        <div class="menu-mobile menu-activated-on-click color-scheme-dark">
          <div class="mm-logo-buttons-w">
            <a class="mm-logo" href="index.html"><img src="{{base_url('userassets/img/logo.png')}}"><span>Clean Admin</span></a>
          ...
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="avatar-w">
                <img alt="" src="{{base_url('userassets/img/avatar1.jpg')}}">
              </div>
            ...
            <ul class="main-menu">
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="apps_pipeline.html">Side &amp; Top Dark <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="apps_pipeline.html">CRM Pipeline <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
              ...
              <li class="has-sub-menu">
                ...
                <ul class="sub-menu">
                  ...
                  <li>
                    <a href="front_home.html">Front Site <strong class="badge badge-danger">New</strong></a>
                  </li>
                  <li>
        ...
        <div class="desktop-menu menu-side-w menu-activated-on-click color-scheme-dark">
          <div class="logo-w">
            <a class="logo" href="index.html"><img src="{{base_url('userassets/img/logo.png')}}"><span>Sistem Pengguna</span></a>
          </div>
          <div class="menu-and-user">
            <div class="logged-user-w">
              <div class="logged-user-i">
                <div class="avatar-w">
                  <img alt="" src="{{$__USER->img_src->xs}}" class="object-cover" width="50" height="50">
                </div>
                <div class="logged-user-info-w">
                  <div class="logged-user-name">
                    {{$__USER->name}}
            ...
            <ul class="main-menu">
              ...
              <li>
                <a href="{{base_url('user/view/tradingidea')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-tasks-checked"></div>
                  </div>
                  <span>Trading Idea</span></a>
              </li>
              <li>
                <a href="{{base_url('user/view/globalindex')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-delivery-box-2"></div>
                  </div>
                  <span>Global Index</span></a>
              </li>
                <li>
                <a href="{{base_url('user/view/stocks')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-delivery-box-2"></div>
                  </div>
                  <span>Stocks</span></a>
              ...
              <li>
                <a href="{{base_url('user/view/earningcalendar')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-pie-chart-3"></div>
                  </div>
                  <span>Earning Calendar</span></a>
              </li>
              <li>
                <a href="{{base_url('user/view/currencies')}}">
                  <div class="icon-w">
              ...
              <li>
                <a href="{{base_url('user/view/commodities')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-bar-chart-stats-up"></div>
                  </div>
              ...
              <li>
                <a href="{{base_url('user/view/economiccalendar')}}">
                  <div class="icon-w">
                    <div class="os-icon os-icon-grid-squares-22"></div>
                  </div>
                  <span>Economic Calendar</span></a>
              </li>
